...
##Switches
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports {Toggle_minmax}];
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { data_433 }]; #IO_L23N_T3_35 Sch=jc[1]
